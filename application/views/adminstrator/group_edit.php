    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr onclick="hide(this)" class="a0">
        ...
        <td height="20"  class="STYLE19"><div><?php if($m['child']){foreach($m['child'] as $c){?><?= $c['name']?>:
                <?php foreach($module_permission[$c['id']] as $m_p){?> <input id="privilege_ids_109" type="checkbox" <?php if($group_permission[$m_p['id']]){?> checked="checked" <?php }?> value="1" name="privilege_ids[]"> <?= $m_p['name'] ?> <?php } ?><br><?php } }?></div></td>
      </tr>
      <?php }?>
    </table></td>
  </tr>
