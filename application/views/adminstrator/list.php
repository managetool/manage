  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">会员名</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">昵称</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">管理组</span></div></td>
      ...
      <tr onclick="hide(this)" class="a0">
        ...
        <td height="20"  class="STYLE19"><div align="center"><?= $v->username?></div></td>
        <td height="20"  class="STYLE19"><div align="center"><?= $v->nickname?></div></td>
          <td height="20"  class="STYLE19"><div align="center"><?= $admin_group[$v->groupid]->name?></div></td>
